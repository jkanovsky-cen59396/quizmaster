...
| 1b — REST workspace, `waitUntil: 'load'` | (pending commit) | 2026-04-21 | 2 | 213s | 216s | 212s | **213s (3m33s)** | 0.8% | 213-214 passed / 1-2 failed / 4 skipped | Break-even vs Step 0 — matches plan estimate ("small win"). Same Quiz.Timer flake. One run had additional AI flake and a fake-clock timing flake (`Quiz.Stats`, `31s != 30s`), both unrelated to change. |
